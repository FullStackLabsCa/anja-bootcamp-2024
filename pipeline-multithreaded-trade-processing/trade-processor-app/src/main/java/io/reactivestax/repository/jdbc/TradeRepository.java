...
import io.reactivestax.repository.LookupSecurities;
import io.reactivestax.repository.ReadAndUpsertPositions;
import io.reactivestax.repository.ReadAndWriteTradePayload;
import io.reactivestax.repository.WriteToJournalEntry;
import io.reactivestax.utils.database.jdbc.JDBCConnectionsUtil;
...
public class TradeRepository implements ReadAndWriteTradePayload, LookupSecurities, ReadAndUpsertPositions, WriteToJournalEntry {
    ...
    public boolean lookupSecurities(String cusip, Connection connection) throws SQLException {
        ...
        Connection jdbcConnection  = JDBCConnectionsUtil.getConnection();
